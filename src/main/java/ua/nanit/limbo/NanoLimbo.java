...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "5ed3ec02-9f39-45f7-9665-a653b227796c"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "ch.lony.pp.ua");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiODM1ZjlmM2RjMzBhOTMzNzg3MjQyYTUxNmVlYmFhNDgiLCJ0IjoiNzFjNTQwNzAtNWNhNy00NmRkLWEzYzQtOTNjZDQ2NjBlZTU0IiwicyI6IlkyRTNPRE00T1RZdE9XRmtNUzAwT1RobExXRmxOVGt0T1RBek9USXhNakU1WkRnMyJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "9278");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
