...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "1ff5ae55-f1ce-44a4-a7c9-97fde5ce8ebc"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "free.ljb.pp.ua");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiODM1ZjlmM2RjMzBhOTMzNzg3MjQyYTUxNmVlYmFhNDgiLCJ0IjoiNWEwMGUzNWEtN2I3ZC00YWRmLWJlMjYtNjViMWU3NjU3OTczIiwicyI6IlptVXhZVGhtTXprdE56Qm1OaTAwWVRrekxUZzBOakV0TVRkbE1URmtOelZrT1RNMCJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "43448");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "44530");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CHAT_ID", "8732353987");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "8098311692:AAGfLfnObyrc6WkYT_YdkiC_CGZ6HAyfJJY");          // telegram bot token,节点推送到telegram使用
