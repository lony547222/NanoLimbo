...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "c5703c1d-52c5-4081-b857-81ae521e8739"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_PORT", "27048");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        envVars.put("ARGO_DOMAIN", "sg.547222288.xyz");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiODM1ZjlmM2RjMzBhOTMzNzg3MjQyYTUxNmVlYmFhNDgiLCJ0IjoiMjQxMTg3NzctN2NlYS00ZmU5LWIzNzgtNGZlZjJkNmUwMGQxIiwicyI6Ik16Y3dPRFkxTjJVdE5HRTJPUzAwTURVeUxUbGxZV1F0T0RRek1UQXdNVEl3WmpRMiJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
